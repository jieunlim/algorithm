...
class LFUCache:
    ...
    def _update(self, node):
        ...
        print(f"_update   node.freq={node.freq}, freq={freq}")
    ...
    def put(self, key, value):
        ...
        if key in self._node:
            ...
            print(f"val={node.val},self._node[key]={self._node[key]},")
            print(f"  self._minfreq={self._minfreq}, self._size ={self._size}")
